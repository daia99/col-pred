...
def train_args():
    ...
    parser.add_argument('--data-path', default='/content/2011_09_28',
    ...
    parser.add_argument('-b', '--batch-size', default=20, type=int) # 16 vs 20
    ...
    parser.add_argument('--resume', default='/content/videowalk/pretrained.pth', help='resume from checkpoint')
    ...
    # model args
    parser.add_argument('--bce-weight', default=1., type=float, help='weight on loss of positive go labels')
    parser.add_argument('--swa', default=False, action='store_true', help='setting for stochastic weight averaging')
    # transformer args
    parser.add_argument('--vit-patch-size', default=2, type=int)
    parser.add_argument('--vit-depth', default=8, type=int)
    parser.add_argument('--head-dropout', default=0., type=float, help='dropout on MLP head hidden layer')
    # dataset args
    parser.add_argument('--img-height', default=128, type=int)
    parser.add_argument('--img-width', default=416, type=int)
    parser.add_argument('--back-context', default=6, type=int, help='number of backward frames to consider as context')
    parser.add_argument('--forward-context', default=8, type=int, help='number of forward labels to consider as context')
    parser.add_argument('--include-curr-frame', default=False, action='store_true', help='setting for adding curr frame to context input')
    parser.add_argument('--create-data-list', default=False, action='store_true', help='create txt file for list of data')
    parser.add_argument('--augment-data', default=False, action='store_true', help='setting for color + flip augmentation')
    parser.add_argument('--label-smooth', default=0., type=float, help='set label smoothing')
